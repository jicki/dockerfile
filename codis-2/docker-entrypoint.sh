...
CMD="/opt/local/codis/bin/codis-proxy --log-level info -c /opt/local/codis/config/config.ini -L /opt/local/codis/logs/proxy.log  --cpu=4 --addr=${prd_proxy}:19000 --http-addr=${prd_proxy}:11000"
