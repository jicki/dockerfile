...
JAVA_OPTS="-Djavax.servlet.request.encoding=UTF-8 -Dfile.encoding=UTF-8 -Duser.timezone=GMT+8 -Xms$MOXMS -Xmx$MOXMX"
...
if [ -z "$CATALINA_OUT" ] ; then
  CATALINA_OUT=/opt/htdocs/logs/$MONAME/catalina.%Y-%m-%d.out
fi
